...
export default function TvPage() {
    ...
    const {page, search, setIsSearching, serieData, navigate, error, isSearching, MIN_PAGE, maxPage, totalSeries, setSearch, err, fetchSearch, fetchTopRated, volverAHome, scrollToTop} = useMovieSerie()
