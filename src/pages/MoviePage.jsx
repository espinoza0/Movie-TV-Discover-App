...
export default function MoviePage() {
    ...
    const {page, search, setIsSearching, movieData, navigate, error, isSearching, MIN_PAGE, maxPage, totalMovies, setSearch, err, fetchSearch, fetchTopRated, volverAHome, scrollToTop} = useMovieSerie()
